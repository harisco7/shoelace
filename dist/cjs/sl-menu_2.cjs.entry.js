...
const Tag = class {
  ...
  render() {
    return (index.h("span", { ref: el => (this.tag = el), part: "base", class: {
      ...
      } }, index.h("span", { part: "content", class: "tag__content" }, index.h("slot", null)), this.clearable && (index.h("sl-icon-button", { exportparts: "base:clear-button", name: "x", class: "tag__clear", onClick: this.handleClearClick }))));
  }
};
Tag.style = tagCss;
