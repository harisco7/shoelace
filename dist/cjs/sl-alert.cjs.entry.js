...
const Alert = class {
  ...
  render() {
    return (index.h("div", { ref: el => (this.alert = el), part: "base", class: {
      ...
      }, role: "alert", "aria-live": "assertive", "aria-atomic": "true", "aria-hidden": this.open ? 'false' : 'true', onMouseMove: this.handleMouseMove, onTransitionEnd: this.handleTransitionEnd }, index.h("span", { part: "icon", class: "alert__icon" }, index.h("slot", { name: "icon" })), index.h("span", { part: "message", class: "alert__message" }, index.h("slot", null)), this.closable && (index.h("span", { class: "alert__close" }, index.h("sl-icon-button", { exportparts: "base:close-button", name: "x", onClick: this.handleCloseClick })))));
  }
