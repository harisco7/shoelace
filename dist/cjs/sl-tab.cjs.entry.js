...
const Tab = class {
  ...
  render() {
    ...
    index.h(index.Host, { id: this.host.id || this.componentId }, index.h("div", { part: "base", ref: el => (this.tab = el), class: {
      ...
      }, role: "tab", "aria-disabled": this.disabled ? 'true' : 'false', "aria-selected": this.active ? 'true' : 'false', tabindex: this.disabled || !this.active ? '-1' : '0' }, index.h("slot", null), this.closable && (index.h("sl-icon-button", { name: "x", exportparts: "base:close-button", class: "tab__close-button", onClick: this.handleCloseClick, tabIndex: -1, "aria-hidden": "true" })))));
  }
