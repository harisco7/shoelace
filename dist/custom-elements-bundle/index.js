...
const ColorPicker = class extends HTMLElement {
  ...
  setCustomValidity(message) {
    return __awaiter$4(this, void 0, void 0, function* () {
      yield this.input.setCustomValidity(message);
...
const requestIcon = (url) => {
  if (iconFiles.has(url)) {
    ...
    const request = fetch(url).then((response) => __awaiter$a(void 0, void 0, void 0, function* () {
      if (response.ok) {
...
const requestInclude = (src, mode = 'cors') => __awaiter$c(void 0, void 0, void 0, function* () {
  if (includeFiles.has(src)) {
    return includeFiles.get(src);
  }
  else {
    const request = fetch(src, { mode: mode }).then((response) => __awaiter$c(void 0, void 0, void 0, function* () {
      return {
        ok: response.ok,
        status: response.status,
