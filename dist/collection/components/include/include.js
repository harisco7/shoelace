...
var Include = /** @class */ (function () {
  ...
  Include.prototype.executeScript = function (script) {
    // Create a copy of the script and swap it out so the browser executes it
    var newScript = document.createElement('script');
    __spreadArrays(script.attributes).map(function (attr) { return newScript.setAttribute(attr.name, attr.value); });
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            if (this.allowScripts) {
              __spreadArrays(this.host.querySelectorAll('script')).map(function (script) { return _this.executeScript(script); });
            }
            this.slLoad.emit();
            return [3 /*break*/, 3];
          case 2:
