...
var Switch = /** @class */ (function () {
  ...
  Switch.prototype.handleCheckedChange = function () {
    this.input.checked = this.checked;
    this.slChange.emit();
  };
  Switch.prototype.connectedCallback = function () {
  ...
  Switch.prototype.setFocus = function (options) {
  ...
  Switch.prototype.removeFocus = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        this.input.blur();
        return [2 /*return*/];
  ...
  Switch.prototype.reportValidity = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
  ...
  Switch.prototype.setCustomValidity = function (message) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
  ...
  Switch.prototype.handleBlur = function () {
    this.hasFocus = false;
    this.slBlur.emit();
  };
  Switch.prototype.handleFocus = function () {
    this.hasFocus = true;
    this.slFocus.emit();
  };
  Switch.prototype.handleKeyDown = function (event) {
  ...
  Switch.prototype.handleMouseDown = function (event) {
  ...
  Switch.prototype.render = function () {
    ...
    return (h("label", { part: "base", htmlFor: this.switchId, class: {
      ...
      h("span", { part: "control", class: "switch__control" },
        ...
        h("input", { ref: function (el) { return (_this.input = el); }, id: this.switchId, type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, role: "switch", "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: this.handleClick, onBlur: this.handleBlur, onFocus: this.handleFocus, onKeyDown: this.handleKeyDown })),
      h("span", { part: "label", id: this.labelId, class: "switch__label" },
        h("slot", null))));
  };
  Object.defineProperty(Switch, "is", {
    get: function () { return "sl-switch"; },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Switch, "encapsulation", {
    get: function () { return "shadow"; },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Switch, "originalStyleUrls", {
    get: function () { return {
      "$": ["switch.scss"]
    }; },
    enumerable: false,
  ...
  Object.defineProperty(Switch, "styleUrls", {
    get: function () { return {
      "$": ["switch.css"]
    }; },
    enumerable: false,
  ...
  Object.defineProperty(Switch, "properties", {
    get: function () { return {
      "name": {
        "type": "string",
        "mutable": false,
      ...
      "required": {
        ...
        "docs": {
          "tags": [],
          "text": "Set to true to make the switch a required field."
        },
        "attribute": "required",
        "reflect": false,
        "defaultValue": "false"
  ...
  Object.defineProperty(Switch, "states", {
    get: function () { return {
      "hasFocus": {}
    }; },
    enumerable: false,
  ...
  Object.defineProperty(Switch, "events", {
    get: function () { return [{
        "method": "slBlur",
        "name": "sl-blur",
        "bubbles": true,
  ...
  Object.defineProperty(Switch, "methods", {
    get: function () { return {
      "setFocus": {
        "complexType": {
