...
import { Component, Element, Event, Method, h } from '@stencil/core';
...
var Menu = /** @class */ (function () {
  ...
  Menu.prototype.render = function () {
    var _this = this;
    return (h("div", { ref: function (el) { return (_this.menu = el); }, part: "base", class: "menu", role: "menu", onClick: this.handleClick, onKeyDown: this.handleKeyDown, tabIndex: 0 },
      h("slot", null)));
  };
