...
var TabGroup = /** @class */ (function () {
  ...
  TabGroup.prototype.handleClick = function (event) {
    ...
    var tabGroup = tab.closest('sl-tab-group');
  ...
  TabGroup.prototype.render = function () {
    ...
    return (h("div", { part: "base", ref: function (el) { return (_this.tabGroup = el); }, class: {
      ...
      h("div", { class: "tab-group__nav-container" },
        this.hasScrollControls && (h("sl-icon-button", { class: "tab-group__scroll-button tab-group__scroll-button--left", exportparts: "base:scroll-button", name: "chevron-left", onClick: this.handleScrollLeft })),
        h("div", { ref: function (el) { return (_this.nav = el); }, key: "nav", part: "nav", class: "tab-group__nav", tabindex: "-1" },
          h("div", { ref: function (el) { return (_this.tabs = el); }, part: "tabs", class: "tab-group__tabs", role: "tablist" },
            ...
            h("slot", { name: "nav" }))),
        this.hasScrollControls && (h("sl-icon-button", { class: "tab-group__scroll-button tab-group__scroll-button--right", exportparts: "base:scroll-button", name: "chevron-right", onClick: this.handleScrollRight }))),
