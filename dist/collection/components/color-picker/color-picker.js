...
var ColorPicker = /** @class */ (function () {
  ...
  ColorPicker.prototype.handleCopy = function () {
    ...
    this.input.select().then(function () {
      ...
      _this.copyButton.setFocus();
      _this.showCopyCheckmark = true;
      setTimeout(function () { return (_this.showCopyCheckmark = false); }, 1000);
    });
  };
      ...
      return (h("div", { part: "base", class: {
        ...
        h("div", { class: "color-picker__controls" },
          ...
          h("div", { part: "preview", class: "color-picker__preview color-picker__transparent-bg", style: {
              color: "hsla(" + _this.hue + "deg, " + _this.saturation + "%, " + _this.lightness + "%, " + _this.alpha / 100 + ")"
            } })),
        h("div", { class: "color-picker__user-input" },
          ...
          h("sl-button", { ref: function (el) { return (_this.copyButton = el); }, exportparts: "base:copy-button", slot: "suffix", class: "color-picker__copy-button", size: "small", circle: true, onClick: _this.handleCopy },
            h("sl-icon", { name: _this.showCopyCheckmark ? 'check2' : 'clipboard' }))),
