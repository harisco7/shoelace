...
var Tab = /** @class */ (function () {
  ...
  Tab.prototype.connectedCallback = function () {
    this.handleCloseClick = this.handleCloseClick.bind(this);
  };
  /** Sets focus to the tab. */
  Tab.prototype.setFocus = function (options) {
  ...
  Tab.prototype.handleCloseClick = function () {
    this.slClose.emit();
  };
  Tab.prototype.render = function () {
    ...
    h(Host, { id: this.host.id || this.componentId },
      h("div", { part: "base", ref: function (el) { return (_this.tab = el); }, class: {
        ...
        h("slot", null),
        this.closable && (h("sl-icon-button", { name: "x", exportparts: "base:close-button", class: "tab__close-button", onClick: this.handleCloseClick, tabIndex: -1, "aria-hidden": "true" })))));
  };
