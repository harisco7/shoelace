import { r as t, c as o, h as i, H as r, g as s } from './p-32052503.js';
import { P as e } from './p-d7e9bd8b.js';
let a = 0;
const n = class {
  constructor(i) {
    t(this, i),
      (this.slShow = o(this, 'sl-show', 7)),
      (this.slAfterShow = o(this, 'sl-aftershow', 7)),
      (this.slHide = o(this, 'sl-hide', 7)),
      (this.slAfterHide = o(this, 'sl-after-hide', 7)),
      (this.componentId = 'tooltip-' + ++a),
      (this.isVisible = !1),
      (this.content = ''),
      (this.placement = 'top'),
      (this.disabled = !1),
  ...
  componentDidLoad() {
    (this.target = this.getTarget()),
      (this.popover = new e(this.target, this.tooltipPositioner)),
      this.syncOptions(),
      this.host.addEventListener('blur', this.handleBlur, !0),
      this.host.addEventListener('click', this.handleClick, !0),
      this.host.addEventListener('focus', this.handleFocus, !0),
  ...
  disconnectedCallback() {
    this.popover.destroy(),
      this.host.removeEventListener('blur', this.handleBlur, !0),
      this.host.removeEventListener('click', this.handleClick, !0),
      this.host.removeEventListener('focus', this.handleFocus, !0);
  }
  async show() {
    this.isVisible ||
      (this.slShow.emit().defaultPrevented
        ? (this.open = !1)
        : ((this.isVisible = !0), (this.open = !0), this.popover.show()));
  }
  async hide() {
    this.isVisible &&
      (this.slHide.emit().defaultPrevented
        ? (this.open = !0)
        : ((this.isVisible = !1), (this.open = !1), this.popover.hide()));
  }
  getTarget() {
    const t = this.host.querySelector('*:not(style)');
    if (!t) throw new Error('Invalid tooltip target: no child element was found.');
    return t;
  }
  handleBlur() {
  ...
  handleKeyDown(t) {
    this.open && 'Escape' === t.key && (t.stopPropagation(), this.hide());
  }
  handleMouseOver() {
    this.hasTrigger('hover') && this.show();
  }
  handleMouseOut() {
    this.hasTrigger('hover') && this.hide();
  }
  handleSlotChange() {
    const t = this.target,
      o = this.getTarget();
    o !== t && (t && t.removeAttribute('aria-describedby'), o.setAttribute('aria-describedby', this.componentId));
  }
  hasTrigger(t) {
  ...
  render() {
    return i(
      ...
      !this.disabled &&
        i(
          'div',
          { ref: t => (this.tooltipPositioner = t), class: 'tooltip-positioner' },
          i(
            'div',
            {
              part: 'base',
