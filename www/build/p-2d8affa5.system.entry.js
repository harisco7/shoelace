            ...
            return t(
              ...
              !this.initials &&
                t(
                  ...
                  t('slot', { name: 'icon' }, t('sl-icon', { name: 'person-fill' }))
                ),
              this.initials && t('div', { part: 'initials', class: 'avatar__initials' }, this.initials),
              this.image &&
                !this.hasError &&
                t('img', { part: 'image', class: 'avatar__image', src: this.image, onError: this.handleImageError })
            );
          };
          return e;
        })()
