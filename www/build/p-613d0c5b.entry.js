import { r as t, h as e } from './p-32052503.js';
const s = class {
  constructor(e) {
    t(this, e), (this.aspectRatio = '16:9');
  }
  ...
  setAspectRatio() {
    const t = this.aspectRatio.split(':'),
      e = parseInt(t[0]),
      s = parseInt(t[1]);
    this.base.style.paddingBottom = e && s ? (s / e) * 100 + '%' : null;
  }
  render() {
    return e(
      'div',
      { ref: t => (this.base = t), part: 'base', class: 'responsive-embed' },
...
export { s as sl_responsive_embed };
