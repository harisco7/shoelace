import { r, h as a, g as o } from './p-32052503.js';
import { h as d } from './p-e1b02254.js';
const e = class {
  constructor(a) {
    r(this, a), (this.hasFooter = !1), (this.hasImage = !1), (this.hasHeader = !1);
  }
  connectedCallback() {
  ...
  handleSlotChange() {
    (this.hasFooter = d(this.host, 'footer')),
      (this.hasImage = d(this.host, 'image')),
      (this.hasHeader = d(this.host, 'header'));
  }
  render() {
    return a(
      'div',
      ...
      a(
        ...
        a('slot', { name: 'image', onSlotchange: this.handleSlotChange })
      ),
      a(
        'div',
        { part: 'header', class: 'card__header' },
        a('slot', { name: 'header', onSlotchange: this.handleSlotChange })
      ),
      a('div', { part: 'body', class: 'card__body' }, a('slot', null)),
      a(
        'div',
        { part: 'footer', class: 'card__footer' },
        a('slot', { name: 'footer', onSlotchange: this.handleSlotChange })
      )
    );
  }
  get host() {
