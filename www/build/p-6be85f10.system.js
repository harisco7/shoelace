      ...
      (function () {
        ...
        function m(t, e) {
          if (void 0 === e.__CE_state) {
            ...
            if (o.defaultView || (o.__CE_isImportDocument && o.__CE_hasRegistry))
          ...
          function i(e) {
            return function (o) {
              ...
              for (var a = [], c = 0; c < i.length; c++) {
                ...
                if (l instanceof DocumentFragment) for (l = l.firstChild; l; l = l.nextSibling) r.push(l);
                else r.push(l);
              }
              e.apply(this, i);
        ...
        function it() {
          ...
          ot(t, Document.prototype, { h: S, append: T });
        }
        function rt() {
          function t(t, o) {
          ...
          void 0 !== J &&
            r(o, 'replaceWith', function (e) {
              ...
              for (var r = [], a = 0; a < o.length; a++) {
                ...
                if (c instanceof DocumentFragment) for (c = c.firstChild; c; c = c.nextSibling) i.push(c);
                else i.push(c);
              }
              a = n(this);
              J.apply(this, o);
        ...
        function ct() {
          ...
          function o(t, e) {
            ...
            r(t, 'insertAdjacentHTML', function (t, o) {
              ...
              else if ('afterend' === t) (i = this.nextSibling), e.call(this, t, o), n(this.nextSibling, i);
              else
        ...
        if (!lt || lt.forcePolyfill || 'function' != typeof lt.define || 'function' != typeof lt.get) {
          ...
          nt();
          it();
          ot(st, DocumentFragment.prototype, { h: D, append: k });
          rt();
          ct();
          document.__CE_hasRegistry = !0;
          var ut = new w(st);
          Object.defineProperty(window, 'customElements', { configurable: !0, enumerable: !0, value: ut });
        }
      }.call(self));
