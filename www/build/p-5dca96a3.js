...
const s = ')(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))?([^,{]*)',
  ...
  m = (s, t) => {
    ...
    return o.escapedString.replace(i, (...s) => {
      ...
      const a = t({ selector: e, content: c });
  ...
  w = s => {
    ...
    for (let s = 0; s < t.length; s++) {
      const r = t[s];
      '}' === r && e--,
        e > 0 ? c.push(r) : (c.length > 0 && (n.push(c.join('')), o.push('%BLOCK%'), (c = [])), o.push(r)),
        '{' === r && e++;
    }
    return c.length > 0 && (n.push(c.join('')), o.push('%BLOCK%')), { escapedString: o.join(''), blocks: n };
  },
  p = (s, t, o) =>
    s.replace(t, (...s) => {
      if (s[2]) {
                ...
                .map(s =>
                  n && s.indexOf('.' + n) > -1
                    ...
                    ? ((s, t, o) => {
                            ...
                            if (s.indexOf('-shadowcsshost-no-combinator') > -1)
                              c = ((s, t, o) => {
                                if (((r.lastIndex = 0), r.test(s))) {
                                  const t = '.' + o;
                                  return s
                                    .replace(e, (s, o) => o.replace(/([^:]*)(:*)(.*)/, (s, o, n, e) => o + t + n + e))
                                    .replace(r, t + ' ');
                                }
                                return t + ' ' + s;
                              })(s, t, o);
                        ...
                        return (
                          (i = i || u.indexOf('-shadowcsshost-no-combinator') > -1),
                          (d += i ? c(u) : u),
                          (m = h.placeholders),
                          d.replace(/__ph-(\d+)__/g, (s, t) => m[+t])
                        );
                        var m;
                      })(s, t, o).trim()
                    : s.trim()
                )
                .join(', '))(s.selector, t, o, n))
  ...
  b = (s, e, r) => {
    ...
    if (r) {
      const t = s => {
        ...
        return b.push({ placeholder: t, comment: `/*!@${s.selector}*/` }), (s.selector = t + s.selector), s;
      };
      s = m(s, s =>
        '@' !== s.selector[0]
          ? t(s)
        ...
        return (
          (s = s.replace(n, (...s) => {
            if (s[2]) {
              ...
              return r.trim() !== h.trim() && e.push({ orgSelector: r, updatedSelector: `${h}, ${r}` }), n;
            }
            return '-shadowcsshost-no-combinator' + s[3];
          })),
          { selectors: e, cssText: s }
        );
      })(
        (s = (s => p(s, o, _))(
          (s = (s => p(s, t, $))(
            (s = s.replace(d, '-shadowcsscontext').replace(h, '-shadowcsshost').replace(a, '-shadowcssslotted'))
          ))
        )),
        g
      );
      return (
        (s = (s => c.reduce((s, t) => s.replace(t, ' '), s))((s = l.cssText))),
        e && (s = f(s, e, r, g)),
        {
          cssText: (s = (s = s.replace(/-shadowcsshost-no-combinator/g, '.' + r)).replace(
            />\s*\*\s+([^{, ]+)/gm,
            ' $1 '
          )).trim(),
    ...
    return (
      (s = [x.cssText, ...w].join('\n')),
      r &&
        b.forEach(({ placeholder: t, comment: o }) => {
          s = s.replace(t, o);
        }),
