import { r as t, c as e, h as a, g as s } from './p-32052503.js';
const f = Object.freeze({
  ...
  r = class {
    constructor(a) {
      t(this, a),
        (this.slCancel = e(this, 'sl-cancel', 7)),
        (this.slFinish = e(this, 'sl-finish', 7)),
        (this.slStart = e(this, 'sl-start', 7)),
        (this.hasStarted = !1),
        (this.name = 'none'),
        (this.delay = 0),
    ...
    handlePauseChange() {
      this.pause ? this.animation.pause() : this.animation.play(),
        this.pause || this.hasStarted || ((this.hasStarted = !0), this.slStart.emit());
    }
    ...
    createAnimation() {
      const t = o[this.easing] || this.easing,
        e = this.keyframes ? this.keyframes : f[this.name],
        a = this.host.shadowRoot.querySelector('slot').assignedElements({ flatten: !0 })[0];
      a &&
        (this.destroyAnimation(),
        (this.animation = a.animate(e, {
          delay: this.delay,
        ...
        this.pause ? this.animation.pause() : ((this.hasStarted = !0), this.slStart.emit()));
    }
    destroyAnimation() {
      this.animation &&
    ...
    async getAnimationNames() {
      return Object.entries(f).map(([t]) => t);
    }
    async getEasingNames() {
      return Object.entries(o).map(([t]) => t);
    }
    ...
    render() {
      return a('slot', { onSlotchange: this.handleSlotChange });
    }
    get host() {
      return s(this);
    }
