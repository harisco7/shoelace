    ...
    function o(n) {
      return function (e) {
        ...
        for (var f = [], c = 0; c < o.length; c++) {
          var s = o[c];
          if ((s instanceof Element && i(s) && f.push(s), s instanceof DocumentFragment))
    ...
    (Z = nt),
      (window.HTMLElement = (function () {
        function t() {
          ...
          return (i[n] = X), Object.setPrototypeOf(e, t.prototype), s(Z, e), e;
        }
        return (
      ...
      (function () {
        ...
        r(Document.prototype, 'createElement', function (n) {
          ...
          return (n = E.call(this, n)), s(t, n), n;
        }),
          ...
          r(Document.prototype, 'createElementNS', function (n, i) {
            ...
            return (n = p.call(this, n, i)), s(t, n), n;
          }),
      ...
      get: function () {
        ...
        return (
          ...
          (n.toggle = function (t, e) {
            void 0 !== e ? (e ? n.add(t) : n.remove(t)) : -1 !== n.indexOf(t) ? n.splice(n.indexOf(t), 1) : n.push(t),
              i();
          }),
          (n.add = function () {
            for (var t = [].slice.call(arguments), e = 0, o = t.length; e < o; e++)
