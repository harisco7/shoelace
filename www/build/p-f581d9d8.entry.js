import { r, h as e } from './p-32052503.js';
const i = class {
  constructor(e) {
    r(this, e), (this.percentage = 0), (this.indeterminate = !1);
  }
  render() {
    return e(
      'div',
      {
        part: 'base',
        class: { 'progress-bar': !0, 'progress-bar--indeterminate': this.indeterminate },
        role: 'progressbar',
        'aria-valuemin': '0',
        'aria-valuemax': '100',
      ...
      e(
        'div',
        { part: 'indicator', class: 'progress-bar__indicator', style: { width: this.percentage + '%' } },
        !this.indeterminate && e('span', { part: 'label', class: 'progress-bar__label' }, e('slot', null))
      )
    );
  }
};
