import { r as t, c as o, h as r, g as i } from './p-32052503.js';
import { h as l } from './p-e1b02254.js';
import { F as s } from './p-4608aa48.js';
const n = class {
  constructor(r) {
    t(this, r),
  ...
  handleClick(t) {
    (this.disabled || this.loading) && (t.preventDefault(), t.stopPropagation());
  }
  render() {
    const t = !!this.href,
      o = !t;
    return r(
      t ? 'a' : 'button',
      {
        ...
        class: {
          button: !0,
          'button--default': 'default' === this.type,
          'button--primary': 'primary' === this.type,
          'button--success': 'success' === this.type,
          'button--info': 'info' === this.type,
          'button--warning': 'warning' === this.type,
          'button--danger': 'danger' === this.type,
          'button--text': 'text' === this.type,
        ...
        disabled: o ? this.disabled : null,
        type: o ? (this.submit ? 'submit' : 'button') : null,
        name: o ? this.name : null,
        value: o ? this.value : null,
        href: t && this.href,
        target: t && this.target ? this.target : null,
        download: t && this.download ? this.download : null,
        rel: t && this.target ? 'noreferrer noopener' : null,
      ...
      r(
        ...
        r('slot', { onSlotchange: this.handleSlotChange, name: 'prefix' })
      ),
      r('span', { part: 'label', class: 'button__label' }, r('slot', { onSlotchange: this.handleSlotChange })),
      r(
        'span',
        { part: 'suffix', class: 'button__suffix' },
        r('slot', { onSlotchange: this.handleSlotChange, name: 'suffix' })
      ),
      this.caret &&
        r(
          'span',
      ...
      this.loading && r('sl-spinner', null)
    );
  }
  get host() {
    return i(this);
...
const e = class {
  constructor(r) {
    t(this, r),
      ...
      (this.slClear = o(this, 'sl-clear', 7)),
      (this.slInput = o(this, 'sl-input', 7)),
      (this.slFocus = o(this, 'sl-focus', 7)),
      (this.slBlur = o(this, 'sl-blur', 7)),
      (this.inputId = 'input-' + ++a),
      (this.labelId = 'input-label-' + a),
      (this.helpTextId = 'input-help-text-' + a),
      (this.hasFocus = !1),
  ...
  async setSelectionRange(t, o, r = 'none') {
    return this.input.setSelectionRange(t, o, r);
  }
  async setRangeText(t, o, r, i = 'preserve') {
    this.input.setRangeText(t, o, r, i),
      this.value !== this.input.value && ((this.value = this.input.value), this.slChange.emit(), this.slInput.emit());
  }
  ...
  handleChange() {
    (this.value = this.input.value), this.slChange.emit();
  }
  handleInput() {
    (this.value = this.input.value), this.slInput.emit();
  }
  handleInvalid() {
    this.invalid = !0;
  }
  ...
  handleSlotChange() {
    (this.hasHelpTextSlot = l(this.host, 'help-text')), (this.hasLabelSlot = l(this.host, 'label'));
  }
  render() {
    var t;
    return r(
      ...
      r(
        'div',
        {
          ...
          class: {
            ...
            'input--empty': 0 === (null === (t = this.value) || void 0 === t ? void 0 : t.length),
            'input--invalid': this.invalid
          }
        },
        r('span', { part: 'prefix', class: 'input__prefix' }, r('slot', { name: 'prefix' })),
        r('input', {
          part: 'input',
          ref: t => (this.input = t),
          id: this.inputId,
        ...
        this.clearable &&
          r(
            ...
            r('slot', { name: 'clear-icon' }, r('sl-icon', { name: 'x-circle' }))
          ),
        this.togglePassword &&
          r(
            'button',
            ...
            this.isPasswordVisible
              ? r('slot', { name: 'show-password-icon' }, r('sl-icon', { name: 'eye-slash' }))
              : r('slot', { name: 'hide-password-icon' }, ' ', r('sl-icon', { name: 'eye' }))
          ),
        r('span', { part: 'suffix', class: 'input__suffix' }, r('slot', { name: 'suffix' }))
      )
    );
  }
  get host() {
...
export { n as sl_button, e as sl_input };
