...
const t = class {
  constructor(i) {
    e(this, i), (this.hasFocus = !1), (this.checked = !1), (this.value = ''), (this.disabled = !1);
  }
  connectedCallback() {
  ...
  render() {
    return i(
      ...
      i(
        ...
        i('sl-icon', { name: 'check2', 'aria-hidden': 'true' })
      ),
      i('span', { part: 'prefix', class: 'menu-item__prefix' }, i('slot', { name: 'prefix' })),
      i('span', { part: 'label', class: 'menu-item__label' }, i('slot', null)),
      i('span', { part: 'suffix', class: 'menu-item__suffix' }, i('slot', { name: 'suffix' }))
    );
  }
};
t.style =
