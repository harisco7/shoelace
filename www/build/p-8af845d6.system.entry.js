    ...
    execute: function () {
      ...
      var i = e(
        ...
        (function () {
          ...
          e.prototype.handlePercentageChange = function () {
            this.updateProgress();
          };
          ...
          e.prototype.updateProgress = function () {
            var e = this.indicator.r.baseVal.value;
            var t = e * 2 * Math.PI;
            var r = t - (this.percentage / 100) * t;
            this.indicator.style.strokeDasharray = t + ' ' + t;
            this.indicator.style.strokeDashoffset = '' + r;
          };
          e.prototype.render = function () {
            ...
            return r(
              ...
              r('span', { part: 'label', class: 'progress-ring__label' }, r('slot', null))
            );
          };
