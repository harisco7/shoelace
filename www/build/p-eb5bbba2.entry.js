import { r as t, c as s, h as i, g as e } from './p-32052503.js';
const r = Object.assign(document.createElement('div'), { className: 'sl-toast-stack' }),
  a = class {
    constructor(i) {
      t(this, i),
        (this.slShow = s(this, 'sl-show', 7)),
        (this.slAfterShow = s(this, 'sl-after-show', 7)),
        (this.slHide = s(this, 'sl-hide', 7)),
        (this.slAfterHide = s(this, 'sl-after-hide', 7)),
        (this.isVisible = !1),
        (this.open = !1),
        (this.closable = !1),
        (this.type = 'primary'),
    ...
    async show() {
      this.isVisible ||
        (this.slShow.emit().defaultPrevented
          ...
          : ((this.isVisible = !0),
            (this.open = !0),
            this.duration < 1 / 0 && (this.autoHideTimeout = setTimeout(() => this.hide(), this.duration))));
    }
    async hide() {
      this.isVisible &&
        (this.slHide.emit().defaultPrevented
          ? (this.open = !0)
          : (clearTimeout(this.autoHideTimeout), (this.isVisible = !1), (this.open = !1)));
    }
    async toast() {
      return new Promise(t => {
        r.parentElement || document.body.append(r),
          r.append(this.host),
          requestAnimationFrame(() => this.show()),
          this.host.addEventListener(
            'sl-after-hide',
            () => {
              this.host.remove(), t(), null === r.querySelector('sl-alert') && r.remove();
            },
            { once: !0 }
          );
      });
    ...
    handleTransitionEnd(t) {
      'opacity' === t.propertyName &&
        t.target.classList.contains('alert') &&
        ((this.isVisible = this.open), this.open ? this.slAfterShow.emit() : this.slAfterHide.emit());
    }
    restartAutoHide() {
      clearTimeout(this.autoHideTimeout),
        this.open && this.duration < 1 / 0 && (this.autoHideTimeout = setTimeout(() => this.hide(), this.duration));
    }
    render() {
      return i(
        'div',
        {
          ...
          class: {
            ...
            'alert--primary': 'primary' === this.type,
            'alert--success': 'success' === this.type,
            'alert--info': 'info' === this.type,
            'alert--warning': 'warning' === this.type,
            'alert--danger': 'danger' === this.type
          },
          role: 'alert',
          'aria-live': 'assertive',
          'aria-atomic': 'true',
        ...
        i('span', { part: 'icon', class: 'alert__icon' }, i('slot', { name: 'icon' })),
        i('span', { part: 'message', class: 'alert__message' }, i('slot', null)),
        this.closable &&
          i(
            'span',
            { class: 'alert__close' },
            i('sl-icon-button', { exportparts: 'base:close-button', name: 'x', onClick: this.handleCloseClick })
          )
      );
    }
    get host() {
