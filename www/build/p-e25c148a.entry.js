import { r as t, c as i, h as e, g as s } from './p-32052503.js';
import { h as r } from './p-e1b02254.js';
import { u as a, l as o } from './p-b8363807.js';
import { i as l, M as n } from './p-9e2e9463.js';
const h = l();
let d = 0;
const p = class {
  constructor(e) {
  ...
  connectedCallback() {
    (this.handleCloseClick = this.handleCloseClick.bind(this)),
      ...
      (this.modal = new n(this.host, { onFocusOut: () => (this.contained ? null : this.panel.focus()) }));
  }
  componentWillLoad() {
    ...
    this.willShow ||
      (this.slShow.emit().defaultPrevented
        ...
        : ((this.willShow = !0),
          (this.isVisible = !0),
          (this.open = !0),
          this.contained || (this.modal.activate(), o(this.host)),
          this.open &&
            (h
  ...
  async hide() {
    this.willHide ||
      (this.slHide.emit().defaultPrevented
        ? (this.open = !0)
        : ((this.willHide = !0), (this.open = !1), this.modal.deactivate(), a(this.host)));
  }
  handleCloseClick() {
    this.hide();
  }
  ...
  handleSlotChange() {
    this.hasFooter = r(this.host, 'footer');
  }
  handleTransitionEnd(t) {
    'transform' === t.propertyName &&
      t.target.classList.contains('drawer__panel') &&
    ...
    return e(
      'div',
      {
        ...
        class: {
          ...
          'drawer--top': 'top' === this.placement,
          'drawer--right': 'right' === this.placement,
          'drawer--bottom': 'bottom' === this.placement,
          'drawer--left': 'left' === this.placement,
      ...
      e('div', { part: 'overlay', class: 'drawer__overlay', onClick: this.handleOverlayClick }),
      e(
        'div',
        {
          ref: t => (this.panel = t),
        ...
        !this.noHeader &&
          e(
            ...
            e(
              ...
              e('slot', { name: 'label' }, this.label || String.fromCharCode(65279))
            ),
            e('sl-icon-button', {
        ...
        e('div', { part: 'body', class: 'drawer__body' }, e('slot', null)),
        e(
          'footer',
