import { r, c as t, h as e, g as i } from './p-32052503.js';
import { c as a } from './p-34f56d3b.js';
function s(r, t, e) {
  return (
    r(
      (e = {
...
var o = {
  ...
  n = s(function (r) {
    var t = Array.prototype.concat,
      ...
      i = (r.exports = function (r) {
        for (var i, a = [], s = 0, o = r.length; s < o; s++) {
          var n = r[s];
          (i = n) &&
          'string' != typeof i &&
          (i instanceof Array ||
            Array.isArray(i) ||
            (i.length >= 0 &&
              (i.splice instanceof Function ||
                (Object.getOwnPropertyDescriptor(i, i.length - 1) && 'String' !== i.constructor.name))))
            ? (a = t.call(a, e.call(n)))
            : a.push(n);
        }
        return a;
  ...
  h = s(function (r) {
    var t = {};
    for (var e in o) o.hasOwnProperty(e) && (t[o[e]] = e);
    var i = (r.exports = { to: {}, get: {} });
    function a(r, t, e) {
    ...
    (i.get = function (r) {
      ...
      return t ? { model: e, value: t } : null;
    }),
      (i.get.rgb = function (r) {
        if (!r) return null;
        var t,
          e,
          i,
          s = [0, 0, 0, 1];
        if ((t = r.match(/^#([a-f0-9]{6})([a-f0-9]{2})?$/i))) {
          for (i = t[2], t = t[1], e = 0; e < 3; e++) {
            var n = 2 * e;
            s[e] = parseInt(t.slice(n, n + 2), 16);
          }
          i && (s[3] = Math.round((parseInt(i, 16) / 255) * 100) / 100);
        } else if ((t = r.match(/^#([a-f0-9]{3,4})$/i))) {
          for (i = (t = t[1])[3], e = 0; e < 3; e++) s[e] = parseInt(t[e] + t[e], 16);
          i && (s[3] = Math.round((parseInt(i + i, 16) / 255) * 100) / 100);
        } else if (
          (t = r.match(/^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/))
        ) {
          for (e = 0; e < 3; e++) s[e] = parseInt(t[e + 1], 0);
          ...
          if (
            ...
            return (t = r.match(/(\D+)/))
              ? 'transparent' === t[1]
                ...
                : null
              : null;
          for (e = 0; e < 3; e++) s[e] = Math.round(2.55 * parseFloat(t[e + 1]));
          t[4] && (s[3] = parseFloat(t[4]));
        }
        for (e = 0; e < 3; e++) s[e] = a(s[e], 0, 255);
        return (s[3] = a(s[3], 0, 1)), s;
      }),
      (i.get.hsl = function (r) {
        if (!r) return null;
        var t = r.match(
        ...
        if (t) {
          ...
          return [
            ...
            a(parseFloat(t[2]), 0, 100),
            a(parseFloat(t[3]), 0, 100),
            a(isNaN(e) ? 1 : e, 0, 1)
          ];
        }
        return null;
      }),
      (i.get.hwb = function (r) {
        if (!r) return null;
        var t = r.match(
      ...
      (i.to.hex = function () {
        var r = n(arguments);
        return '#' + s(r[0]) + s(r[1]) + s(r[2]) + (r[3] < 1 ? s(Math.round(255 * r[3])) : '');
      }),
      (i.to.rgb = function () {
        var r = n(arguments);
        return r.length < 4 || 1 === r[3]
          ? 'rgb(' + Math.round(r[0]) + ', ' + Math.round(r[1]) + ', ' + Math.round(r[2]) + ')'
          : 'rgba(' + Math.round(r[0]) + ', ' + Math.round(r[1]) + ', ' + Math.round(r[2]) + ', ' + r[3] + ')';
      }),
      (i.to.rgb.percent = function () {
        var r = n(arguments),
          t = Math.round((r[0] / 255) * 100),
          e = Math.round((r[1] / 255) * 100),
          i = Math.round((r[2] / 255) * 100);
        return r.length < 4 || 1 === r[3]
          ? 'rgb(' + t + '%, ' + e + '%, ' + i + '%)'
          : 'rgba(' + t + '%, ' + e + '%, ' + i + '%, ' + r[3] + ')';
      }),
      ...
      (i.to.hwb = function () {
        var r = n(arguments),
          t = '';
        return (
          r.length >= 4 && 1 !== r[3] && (t = ', ' + r[3]), 'hwb(' + r[0] + ', ' + r[1] + '%, ' + r[2] + '%' + t + ')'
        );
      }),
      (i.to.keyword = function (r) {
  ...
  l = s(function (r) {
    ...
    for (var a in i)
      if (i.hasOwnProperty(a)) {
        ...
        delete i[a].channels,
          delete i[a].labels,
          Object.defineProperty(i[a], 'channels', { value: s }),
          Object.defineProperty(i[a], 'labels', { value: n });
      }
    (i.rgb.hsl = function (r) {
      ...
      return (
        ...
        (e = (o + n) / 2),
        [t, 100 * (n === o ? 0 : e <= 0.5 ? h / (n + o) : h / (2 - n - o)), 100 * e]
      );
    }),
        ...
        return (
          0 === c
            ...
            : ((s = c / l),
              ...
              (e = u(n)),
              (i = u(h)),
              o === l ? (a = i - e) : n === l ? (a = 1 / 3 + t - i) : h === l && (a = 2 / 3 + e - t),
              a < 0 ? (a += 1) : a > 1 && (a -= 1)),
          [360 * a, 100 * s, 100 * l]
        );
      }),
      (i.rgb.hwb = function (r) {
        ...
        return [
          i.rgb.hsl(r)[0],
          (1 / 255) * Math.min(t, Math.min(e, a)) * 100,
          100 * (a = 1 - (1 / 255) * Math.max(t, Math.max(e, a)))
        ];
      }),
      (i.rgb.cmyk = function (r) {
        var t,
          ...
          a = r[2] / 255;
        return [
          100 * ((1 - e - (t = Math.min(1 - e, 1 - i, 1 - a))) / (1 - t) || 0),
          100 * ((1 - i - t) / (1 - t) || 0),
          100 * ((1 - a - t) / (1 - t) || 0),
          100 * t
        ];
      ...
      (i.rgb.keyword = function (r) {
        ...
        for (var h in o)
          if (o.hasOwnProperty(h)) {
            var l =
              ((a = r), (s = o[h]), Math.pow(a[0] - s[0], 2) + Math.pow(a[1] - s[1], 2) + Math.pow(a[2] - s[2], 2));
            l < n && ((n = l), (i = h));
          }
        return i;
      }),
        ...
        return [
          100 *
            (0.4124 * (t = t > 0.04045 ? Math.pow((t + 0.055) / 1.055, 2.4) : t / 12.92) +
              0.3576 * (e = e > 0.04045 ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92) +
              0.1805 * (i = i > 0.04045 ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92)),
          100 * (0.2126 * t + 0.7152 * e + 0.0722 * i),
          100 * (0.0193 * t + 0.1192 * e + 0.9505 * i)
        ];
      }),
      (i.rgb.lab = function (r) {
        ...
        return (
          ...
          [
            ...
            500 * (e - a),
            200 * (a - (s = s > 0.008856 ? Math.pow(s, 1 / 3) : 7.787 * s + 16 / 116))
          ]
        );
      }),
      (i.hsl.rgb = function (r) {
        var t,
          ...
          n = r[1] / 100,
          h = r[2] / 100;
        if (0 === n) return [(s = 255 * h), s, s];
        (t = 2 * h - (e = h < 0.5 ? h * (1 + n) : h + n - h * n)), (a = [0, 0, 0]);
        for (var l = 0; l < 3; l++)
          (i = o + (1 / 3) * -(l - 1)) < 0 && i++,
            i > 1 && i--,
            (a[l] =
              255 *
              (s = 6 * i < 1 ? t + 6 * (e - t) * i : 2 * i < 1 ? e : 3 * i < 2 ? t + (e - t) * (2 / 3 - i) * 6 : t));
        return a;
      }),
      (i.hsl.hsv = function (r) {
        ...
        return (
          (e *= (i *= 2) <= 1 ? i : 2 - i),
          (a *= s <= 1 ? s : 2 - s),
          [t, 100 * (0 === i ? (2 * a) / (s + a) : (2 * e) / (i + e)), ((i + e) / 2) * 100]
        );
      }),
      ...
      (i.hsv.hsl = function (r) {
        ...
        return (
          (i = (2 - s) * o),
          (e = s * n),
          [a, 100 * (e = (e /= (t = (2 - s) * n) <= 1 ? t : 2 - t) || 0), 100 * (i /= 2)]
        );
      }),
      ...
      (i.cmyk.rgb = function (r) {
        var t = r[1] / 100,
          ...
          i = r[3] / 100;
        return [
          255 * (1 - Math.min(1, (r[0] / 100) * (1 - i) + i)),
      ...
      (i.xyz.rgb = function (r) {
        var t,
          ...
          o = r[2] / 100;
        return (
          (e = -0.9689 * a + 1.8758 * s + 0.0415 * o),
          (i = 0.0557 * a + -0.204 * s + 1.057 * o),
          (t =
            (t = 3.2406 * a + -1.5372 * s + -0.4986 * o) > 0.0031308
              ? 1.055 * Math.pow(t, 1 / 2.4) - 0.055
              : 12.92 * t),
          (e = e > 0.0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : 12.92 * e),
      ...
      (i.xyz.lab = function (r) {
        ...
        return (
          ...
          [
            116 * (e = e > 0.008856 ? Math.pow(e, 1 / 3) : 7.787 * e + 16 / 116) - 16,
            500 * (t - e),
            200 * (e - (i = i > 0.008856 ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116))
          ]
        );
      }),
      (i.lab.xyz = function (r) {
        var t, e, i;
        (t = r[1] / 500 + (e = (r[0] + 16) / 116)), (i = e - r[2] / 200);
        var a = Math.pow(e, 3),
          s = Math.pow(t, 3),
          o = Math.pow(i, 3);
        return (
      ...
      (i.lab.lch = function (r) {
        var t,
          ...
          i = r[1],
          a = r[2];
        return (t = (360 * Math.atan2(a, i)) / 2 / Math.PI) < 0 && (t += 360), [e, Math.sqrt(i * i + a * a), t];
      }),
      (i.lch.lab = function (r) {
        var t,
          e = r[1];
        return (t = (r[2] / 360) * 2 * Math.PI), [r[0], e * Math.cos(t), e * Math.sin(t)];
      }),
      (i.rgb.ansi16 = function (r) {
        var t = r[0],
          e = r[1],
          a = r[2],
          s = 1 in arguments ? arguments[1] : i.rgb.hsv(r)[2];
        if (0 === (s = Math.round(s / 50))) return 30;
        var o = 30 + ((Math.round(a / 255) << 2) | (Math.round(e / 255) << 1) | Math.round(t / 255));
        return 2 === s && (o += 60), o;
      }),
      ...
      (i.rgb.ansi256 = function (r) {
        ...
        return t === e && e === i
          ...
          : 16 + 36 * Math.round((t / 255) * 5) + 6 * Math.round((e / 255) * 5) + Math.round((i / 255) * 5);
      }),
      (i.ansi16.rgb = function (r) {
        var t = r % 10;
        if (0 === t || 7 === t) return r > 50 && (t += 3.5), [(t = (t / 10.5) * 255), t, t];
        var e = 0.5 * (1 + ~~(r > 50));
      ...
      (i.ansi256.rgb = function (r) {
        ...
        var e;
        return (
          (r -= 16), [(Math.floor(r / 36) / 5) * 255, (Math.floor((e = r % 36) / 6) / 5) * 255, ((e % 6) / 5) * 255]
        );
      }),
      (i.rgb.hex = function (r) {
        var t = (((255 & Math.round(r[0])) << 16) + ((255 & Math.round(r[1])) << 8) + (255 & Math.round(r[2])))
          .toString(16)
          .toUpperCase();
      ...
      (i.rgb.hcg = function (r) {
        var t,
          ...
          i = r[1] / 255,
          a = r[2] / 255,
          s = Math.max(Math.max(e, i), a),
          o = Math.min(Math.min(e, i), a),
          n = s - o;
        return (
          (t = n <= 0 ? 0 : s === e ? ((i - a) / n) % 6 : s === i ? 2 + (a - e) / n : 4 + (e - i) / n + 4),
          (t /= 6),
          [360 * (t %= 1), 100 * n, 100 * (n < 1 ? o / (1 - n) : 0)]
        );
      }),
      (i.hsl.hcg = function (r) {
        var t,
          ...
          a = 0;
        return (
          (t = i < 0.5 ? 2 * e * i : 2 * e * (1 - i)) < 1 && (a = (i - 0.5 * t) / (1 - t)), [r[0], 100 * t, 100 * a]
        );
      }),
      (i.hsv.hcg = function (r) {
        var t = r[2] / 100,
          e = (r[1] / 100) * t,
          i = 0;
        return e < 1 && (i = (t - e) / (1 - e)), [r[0], 100 * e, 100 * i];
      }),
      (i.hcg.rgb = function (r) {
        ...
        return [255 * (t * a[0] + (i = (1 - t) * e)), 255 * (t * a[1] + i), 255 * (t * a[2] + i)];
      }),
      (i.hcg.hsv = function (r) {
        var t = r[1] / 100,
          e = t + (r[2] / 100) * (1 - t),
          i = 0;
        return e > 0 && (i = t / e), [r[0], 100 * i, 100 * e];
      }),
      (i.hcg.hsl = function (r) {
        var t = r[1] / 100,
          ...
          i = 0;
        return (
          e > 0 && e < 0.5 ? (i = t / (2 * e)) : e >= 0.5 && e < 1 && (i = t / (2 * (1 - e))), [r[0], 100 * i, 100 * e]
        );
      }),
      (i.hcg.hwb = function (r) {
        var t = r[1] / 100,
          e = t + (r[2] / 100) * (1 - t);
        return [r[0], 100 * (e - t), 100 * (1 - e)];
      }),
      ...
      (i.gray.hex = function (r) {
        var t = 255 & Math.round((r[0] / 100) * 255),
          e = ((t << 16) + (t << 8) + t).toString(16).toUpperCase();
...
function u(r, t) {
  for (var e = [t[r].parent, r], i = l[t[r].parent][r], a = t[r].parent; t[a].parent; )
    e.unshift(t[a].parent), (i = c(l[t[a].parent][a], i)), (a = t[a].parent);
  return (i.conversion = e), i;
}
var d = {};
Object.keys(l).forEach(function (r) {
  (d[r] = {}),
    Object.defineProperty(d[r], 'channels', { value: l[r].channels }),
    Object.defineProperty(d[r], 'labels', { value: l[r].labels });
  var t = (function (r) {
    for (
      var t = (function (r) {
          var t = (function () {
              for (var r = {}, t = Object.keys(l), e = t.length, i = 0; i < e; i++)
                r[t[i]] = { distance: -1, parent: null };
              return r;
            })(),
            e = [r];
          for (t[r].distance = 0; e.length; )
            for (var i = e.pop(), a = Object.keys(l[i]), s = a.length, o = 0; o < s; o++) {
              var n = a[o],
                h = t[n];
              -1 === h.distance && ((h.distance = t[i].distance + 1), (h.parent = i), e.unshift(n));
            }
          return t;
        })(r),
        e = {},
  ...
  Object.keys(t).forEach(function (e) {
    ...
    (d[r][e] = (function (r) {
      var t = function (t) {
        ...
        var e = r(t);
        if ('object' == typeof e) for (var i = e.length, a = 0; a < i; a++) e[a] = Math.round(e[a]);
        return e;
      };
      return 'conversion' in r && (t.conversion = r.conversion), t;
    })(i)),
      (d[r][e].raw = (function (r) {
        var t = function (t) {
          return null == t ? t : (arguments.length > 1 && (t = Array.prototype.slice.call(arguments)), r(t));
        };
        return 'conversion' in r && (t.conversion = r.conversion), t;
      })(i));
  });
...
Object.keys(p).forEach(function (r) {
  b[g.call(p[r].labels).sort().join('')] = r;
});
var v = {};
function w(r, t) {
  if (!(this instanceof w)) return new w(r, t);
  if ((t && t in f && (t = null), t && !(t in p))) throw new Error('Unknown model: ' + t);
  var e, i;
  if (null == r) (this.model = 'rgb'), (this.color = [0, 0, 0]), (this.valpha = 1);
  else if (r instanceof w) (this.model = r.model), (this.color = r.color.slice()), (this.valpha = r.valpha);
  else if ('string' == typeof r) {
    var a = h.get(r);
    if (null === a) throw new Error('Unable to parse color from string: ' + r);
    (this.model = a.model),
      (this.color = a.value.slice(0, (i = p[this.model].channels))),
      (this.valpha = 'number' == typeof a.value[i] ? a.value[i] : 1);
  } else if (r.length) {
    this.model = t || 'rgb';
    var s = g.call(r, 0, (i = p[this.model].channels));
    (this.color = _(s, i)), (this.valpha = 'number' == typeof r[i] ? r[i] : 1);
  } else if ('number' == typeof r)
    (r &= 16777215), (this.model = 'rgb'), (this.color = [(r >> 16) & 255, (r >> 8) & 255, 255 & r]), (this.valpha = 1);
  else {
    this.valpha = 1;
    var o = Object.keys(r);
    'alpha' in r && (o.splice(o.indexOf('alpha'), 1), (this.valpha = 'number' == typeof r.alpha ? r.alpha : 0));
    var n = o.sort().join('');
    if (!(n in b)) throw new Error('Unable to parse color from object: ' + JSON.stringify(r));
    this.model = b[n];
    var l = p[this.model].labels,
      c = [];
    for (e = 0; e < l.length; e++) c.push(r[l[e]]);
    this.color = _(c);
  }
  if (v[this.model])
    for (i = p[this.model].channels, e = 0; e < i; e++) {
      var u = v[this.model][e];
  ...
  return (
    ...
    function (i) {
      ...
      return arguments.length
        ? (e && (i = e(i)), ((a = this[r]()).color[t] = i), a)
        : ((a = this[r]().color[t]), e && (a = e(a)), a);
    }
  );
}
function k(r) {
...
function _(r, t) {
  for (var e = 0; e < t; e++) 'number' != typeof r[e] && (r[e] = 0);
  return r;
}
(w.prototype = {
  toString: function () {
  ...
  string: function (r) {
    var t = this.model in h.to ? this : this.rgb(),
      e = 1 === (t = t.round('number' == typeof r ? r : 1)).valpha ? t.color : t.color.concat(this.valpha);
    return h.to[t.model](e);
  },
  percentString: function (r) {
    var t = this.rgb().round('number' == typeof r ? r : 1),
      e = 1 === t.valpha ? t.color : t.color.concat(this.valpha);
    return h.to.rgb.percent(e);
  },
  array: function () {
    return 1 === this.valpha ? this.color.slice() : this.color.concat(this.valpha);
  },
  object: function () {
    for (var r = {}, t = p[this.model].channels, e = p[this.model].labels, i = 0; i < t; i++) r[e[i]] = this.color[i];
  ...
  alpha: function (r) {
    return arguments.length ? new w(this.color.concat(Math.max(0, Math.min(1, r))), this.model) : this.valpha;
  },
  red: m('rgb', 0, k(255)),
  green: m('rgb', 1, k(255)),
  blue: m('rgb', 2, k(255)),
  hue: m(['hsl', 'hsv', 'hsl', 'hwb', 'hcg'], 0, function (r) {
    return ((r % 360) + 360) % 360;
  }),
  saturationl: m('hsl', 1, k(100)),
  lightness: m('hsl', 2, k(100)),
  saturationv: m('hsv', 1, k(100)),
  value: m('hsv', 2, k(100)),
  chroma: m('hcg', 1, k(100)),
  gray: m('hcg', 2, k(100)),
  white: m('hwb', 1, k(100)),
  wblack: m('hwb', 2, k(100)),
  cyan: m('cmyk', 0, k(100)),
  magenta: m('cmyk', 1, k(100)),
  yellow: m('cmyk', 2, k(100)),
  black: m('cmyk', 3, k(100)),
  x: m('xyz', 0, k(100)),
  y: m('xyz', 1, k(100)),
  z: m('xyz', 2, k(100)),
  l: m('lab', 0, k(100)),
  ...
  b: m('lab', 2),
  keyword: function (r) {
    return arguments.length ? new w(r) : p[this.model].keyword(this.color);
  },
  hex: function (r) {
    return arguments.length ? new w(r) : h.to.hex(this.rgb().round().color);
  },
  rgbNumber: function () {
    var r = this.rgb().color;
  ...
  luminosity: function () {
    for (var r = this.rgb().color, t = [], e = 0; e < r.length; e++) {
      var i = r[e] / 255;
      t[e] = i <= 0.03928 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4);
    }
  ...
  rotate: function (r) {
    var t = this.hsl(),
      e = t.color[0];
    return (t.color[0] = e = (e = (e + r) % 360) < 0 ? 360 + e : e), t;
  },
  mix: function (r, t) {
    if (!r || !r.rgb)
    ...
    var e = r.rgb(),
      ...
      s = 2 * a - 1,
      o = e.alpha() - i.alpha(),
      n = ((s * o == -1 ? s : (s + o) / (1 + s * o)) + 1) / 2,
      h = 1 - n;
    return w.rgb(
      n * e.red() + h * i.red(),
      n * e.green() + h * i.green(),
      n * e.blue() + h * i.blue(),
      e.alpha() * a + i.alpha() * (1 - a)
    );
  }
}),
  Object.keys(p).forEach(function (r) {
    if (-1 === f.indexOf(r)) {
      ...
      (w.prototype[r] = function () {
        if (this.model === r) return new w(this);
        if (arguments.length) return new w(arguments, r);
        var e = 'number' == typeof arguments[t] ? t : this.valpha;
        return new w(y(p[this.model][r].raw(this.color)).concat(e), r);
      }),
        (w[r] = function (e) {
          return 'number' == typeof e && (e = _(g.call(arguments), t)), new w(e, r);
        });
    }
  });
var x = w;
const M = class {
  constructor(e) {
    r(this, e),
      (this.slChange = t(this, 'sl-change', 7)),
    ...
    if (!this.bypassValueParse) {
      ...
      e
        ? ((this.inputValue = this.value),
          (this.hue = e.hsla.h),
          (this.saturation = e.hsla.s),
          (this.lightness = e.hsla.l),
          (this.alpha = 100 * e.hsla.a))
        : (this.inputValue = t);
    }
    this.value !== this.lastValueEmitted && (this.slChange.emit(), (this.lastValueEmitted = this.value));
  }
  connectedCallback() {
  ...
  componentWillLoad() {
    this.setColor(this.value) || this.setColor('#ffff'),
      (this.inputValue = this.value),
      (this.lastValueEmitted = this.value),
      this.syncValues();
  }
  async getFormattedValue(r = 'hex') {
    const t = this.parseColor(`hsla(${this.hue}, ${this.saturation}%, ${this.lightness}%, ${this.alpha / 100})`);
    if (!t) return '';
    switch (r) {
      case 'hex':
        return t.hex;
  ...
  async reportValidity() {
    return !this.inline && this.input.invalid
      ? new Promise(r => {
          this.dropdown.addEventListener(
            'sl-after-show',
            () => {
              this.input.reportValidity(), r();
            },
            { once: !0 }
          ),
            this.dropdown.show();
  ...
  async setCustomValidity(r) {
    await this.input.setCustomValidity(r), (this.invalid = this.input.invalid);
  }
  handleCopy() {
    this.input.select().then(() => {
      document.execCommand('copy'),
        this.previewButton.focus(),
        (this.showCopyFeedback = !0),
        this.previewButton.addEventListener('animationend', () => (this.showCopyFeedback = !1), { once: !0 });
    });
  }
  handleFormatToggle() {
    const r = ['hex', 'rgb', 'hsl'],
      t = (r.indexOf(this.format) + 1) % r.length;
    this.format = r[t];
  }
  handleHueInput(r) {
    this.hue = a(Number(r.target.value), 0, 360);
  }
  handleSaturationInput(r) {
    this.saturation = a(Number(r.target.value), 0, 100);
  }
  handleLightnessInput(r) {
    this.lightness = a(Number(r.target.value), 0, 100);
  }
  handleAlphaInput(r) {
    this.alpha = a(Number(r.target.value), 0, 100);
  }
  handleAlphaDrag(r) {
    const t = this.host.shadowRoot.querySelector('.color-picker__slider.color-picker__alpha'),
      e = t.querySelector('.color-picker__slider-handle'),
      { width: i } = t.getBoundingClientRect();
    e.focus(),
      r.preventDefault(),
      this.handleDrag(r, t, r => {
        (this.alpha = a((r / i) * 100, 0, 100)), this.syncValues();
      });
  }
  handleHueDrag(r) {
    const t = this.host.shadowRoot.querySelector('.color-picker__slider.color-picker__hue'),
      e = t.querySelector('.color-picker__slider-handle'),
      { width: i } = t.getBoundingClientRect();
    e.focus(),
      r.preventDefault(),
      this.handleDrag(r, t, r => {
        (this.hue = a((r / i) * 360, 0, 360)), this.syncValues();
      });
  }
  handleGridDrag(r) {
    const t = this.host.shadowRoot.querySelector('.color-picker__grid'),
      e = t.querySelector('.color-picker__grid-handle'),
      { width: i, height: s } = t.getBoundingClientRect();
    e.focus(),
      r.preventDefault(),
      this.handleDrag(r, t, (r, t) => {
        (this.saturation = a((r / i) * 100, 0, 100)),
          (this.lightness = a(100 - (t / s) * 100, 0, 100)),
          this.syncValues();
      });
  }
  handleDrag(r, t, e) {
    ...
    const i = r => {
      ...
      e(
        (r.changedTouches ? r.changedTouches[0].pageX : r.pageX) - (i.left + t.ownerDocument.defaultView.pageXOffset),
        (r.changedTouches ? r.changedTouches[0].pageY : r.pageY) - (i.top + t.ownerDocument.defaultView.pageYOffset)
      );
    };
    i(r);
    const a = () => {
  ...
  handleAlphaKeyDown(r) {
    const t = r.shiftKey ? 10 : 1;
    'ArrowLeft' === r.key && (r.preventDefault(), (this.alpha = a(this.alpha - t, 0, 100)), this.syncValues()),
      'ArrowRight' === r.key && (r.preventDefault(), (this.alpha = a(this.alpha + t, 0, 100)), this.syncValues()),
      'Home' === r.key && (r.preventDefault(), (this.alpha = 0), this.syncValues()),
      'End' === r.key && (r.preventDefault(), (this.alpha = 100), this.syncValues());
  }
  handleHueKeyDown(r) {
    const t = r.shiftKey ? 10 : 1;
    'ArrowLeft' === r.key && (r.preventDefault(), (this.hue = a(this.hue - t, 0, 360)), this.syncValues()),
      'ArrowRight' === r.key && (r.preventDefault(), (this.hue = a(this.hue + t, 0, 360)), this.syncValues()),
      'Home' === r.key && (r.preventDefault(), (this.hue = 0), this.syncValues()),
      'End' === r.key && (r.preventDefault(), (this.hue = 360), this.syncValues());
  }
  handleGridKeyDown(r) {
    const t = r.shiftKey ? 10 : 1;
    'ArrowLeft' === r.key &&
      (r.preventDefault(), (this.saturation = a(this.saturation - t, 0, 100)), this.syncValues()),
      'ArrowRight' === r.key &&
        (r.preventDefault(), (this.saturation = a(this.saturation + t, 0, 100)), this.syncValues()),
      'ArrowUp' === r.key && (r.preventDefault(), (this.lightness = a(this.lightness + t, 0, 100)), this.syncValues()),
      'ArrowDown' === r.key &&
        (r.preventDefault(), (this.lightness = a(this.lightness - t, 0, 100)), this.syncValues());
  }
  handleInputChange(r) {
    const t = r.target;
    this.setColor(t.value), (t.value = this.value), r.stopPropagation();
  }
  handleInputKeyDown(r) {
    'Enter' === r.key &&
      (this.setColor(this.input.value), (this.input.value = this.value), setTimeout(() => this.input.select()));
  }
  handleDocumentMouseDown(r) {
    r.target.closest('sl-color-picker') !== this.host && this.dropdown.hide();
  }
  handleDropdownShow(r) {
    r.stopPropagation(), this.slShow.emit();
  }
  handleDropdownAfterShow(r) {
    r.stopPropagation(), this.slAfterShow.emit();
  }
  handleDropdownHide(r) {
    r.stopPropagation(), this.slHide.emit();
  }
  handleDropdownAfterHide(r) {
    r.stopPropagation(), this.slAfterHide.emit(), (this.showCopyFeedback = !1);
  }
  normalizeColorString(r) {
    if (/rgba?/i.test(r)) {
      const t = r
        .replace(/[^\d.%]/g, ' ')
        .split(' ')
      ...
      return (
        t.length < 4 && (t[3] = '1'),
        t[3].indexOf('%') > -1 && (t[3] = (Number(t[3].replace(/%/g, '')) / 100).toString()),
  ...
  parseColor(r) {
    ...
    let e;
    r = this.normalizeColorString(r);
    try {
      e = x(r);
    } catch (r) {
      return !1;
    }
    const i = { h: e.hsl().color[0], s: e.hsl().color[1], l: e.hsl().color[2], a: e.hsl().valpha },
      a = { r: e.rgb().color[0], g: e.rgb().color[1], b: e.rgb().color[2], a: e.rgb().valpha },
      s = t(e.rgb().color[0]),
      o = t(e.rgb().color[1]),
      n = t(e.rgb().color[2]),
      h = t(255 * e.rgb().valpha);
    return {
      hsl: {
        h: i.h,
        s: i.s,
        l: i.l,
        string: this.setLetterCase(`hsl(${Math.round(i.h)}, ${Math.round(i.s)}%, ${Math.round(i.l)}%)`)
      },
      hsla: {
        h: i.h,
        s: i.s,
        ...
        string: this.setLetterCase(
          `hsla(${Math.round(i.h)}, ${Math.round(i.s)}%, ${Math.round(i.l)}%, ${Number(i.a.toFixed(2).toString())})`
        )
      },
      rgb: {
        r: a.r,
        g: a.g,
        b: a.b,
        string: this.setLetterCase(`rgb(${Math.round(a.r)}, ${Math.round(a.g)}, ${Math.round(a.b)})`)
      },
      rgba: {
        r: a.r,
        g: a.g,
        ...
        a: a.a,
        string: this.setLetterCase(
          `rgba(${Math.round(a.r)}, ${Math.round(a.g)}, ${Math.round(a.b)}, ${Number(a.a.toFixed(2).toString())})`
        )
      },
      hex: this.setLetterCase(`#${s}${o}${n}`),
      hexa: this.setLetterCase(`#${s}${o}${n}${h}`)
    };
  }
  setColor(r) {
    const t = this.parseColor(r);
    return (
      !!t &&
      ((this.hue = t.hsla.h),
      (this.saturation = t.hsla.s),
      (this.lightness = t.hsla.l),
      (this.alpha = this.opacity ? 100 * t.hsla.a : 100),
      this.syncValues(),
      !0)
    );
  }
  setLetterCase(r) {
    return 'string' != typeof r ? '' : this.uppercase ? r.toUpperCase() : r.toLowerCase();
  }
  syncValues() {
    const r = this.parseColor(`hsla(${this.hue}, ${this.saturation}%, ${this.lightness}%, ${this.alpha / 100})`);
    if (!r) return !1;
    (this.inputValue =
      'hsl' === this.format
        ? this.opacity
        ...
        ? r.hexa
        : r.hex),
      (this.bypassValueParse = !0),
      (this.value = this.inputValue),
      (this.bypassValueParse = !1);
  }
  render() {
    const r = this.saturation,
      t = 100 - this.lightness,
      i = () =>
        e(
          'div',
          {
            part: 'base',
            class: { 'color-picker': !0, 'color-picker--inline': this.inline, 'color-picker--disabled': this.disabled },
          ...
          e(
            'div',
            {
              ...
              style: { backgroundColor: `hsl(${this.hue}deg, 100%, 50%)` },
          ...
          e(
            ...
            e(
              ...
              e(
                ...
                e('span', {
                  ...
                  style: { left: (0 === this.hue ? 0 : 100 / (360 / this.hue)) + '%' },
                  role: 'slider',
                  'aria-label': 'hue',
            ...
            e(
              'button',
              {
                ref: r => (this.previewButton = r),
                type: 'button',
                part: 'preview',
                class: 'color-picker__preview color-picker__transparent-bg',
                style: {
                  '--preview-color': `hsla(${this.hue}deg, ${this.saturation}%, ${this.lightness}%, ${
                    this.alpha / 100
                  })`
                },
          ...
          e(
            'div',
            { class: 'color-picker__user-input' },
            e('sl-input', {
              ref: r => (this.input = r),
              part: 'input',
              size: 'small',
            ...
            !this.noFormatToggle &&
              e(
                'sl-button',
                { exportparts: 'base:format-button', size: 'small', onClick: this.handleFormatToggle },
          ...
          this.swatches &&
            e(
              'div',
              { part: 'swatches', class: 'color-picker__swatches' },
              this.swatches.map(r =>
                e(
                  'div',
                  {
                    ...
                    role: 'button',
                    'aria-label': r,
                    onClick: () => !this.disabled && this.setColor(r),
                    onKeyDown: t => !this.disabled && 'Enter' === t.key && this.setColor(r)
                  },
                  e('div', { class: 'color-picker__swatch-color', style: { backgroundColor: r } })
                )
              )
            )
        );
      ...
      : e(
          ...
          e('button', {
            ...
            class: {
              ...
              'color-dropdown__trigger--small': 'small' === this.size,
              'color-dropdown__trigger--medium': 'medium' === this.size,
              'color-dropdown__trigger--large': 'large' === this.size,
              'color-picker__transparent-bg': !0
            },
            style: { color: `hsla(${this.hue}deg, ${this.saturation}%, ${this.lightness}%, ${this.alpha / 100})` },
            type: 'button'
          }),
          e(i, null)
        );
  ...
  static get watchers() {
    return { format: ['handleFormatChange'], opacity: ['handleOpacityChange'], value: ['handleValueChange'] };
  }
};
M.style =
