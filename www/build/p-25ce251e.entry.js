import { r as o, c as r, h as i, g as s } from './p-32052503.js';
let t = 0;
const e = class {
  constructor(i) {
    o(this, i),
      ...
      (this.inputId = 'radio-' + ++t),
      (this.labelId = 'radio-label-' + t),
      (this.hasFocus = !1),
      (this.disabled = !1),
      (this.checked = !1),
      (this.invalid = !1);
  ...
  handleCheckedChange() {
    this.checked && this.getSiblingRadios().map(o => (o.checked = !1)),
  ...
  getAllRadios() {
    const o = this.host.closest('sl-form, form') || document.body;
    return this.name ? [...o.querySelectorAll('sl-radio')].filter(o => o.name === this.name) : [];
  }
  getSiblingRadios() {
    return this.getAllRadios().filter(o => o !== this.host);
  }
  handleClick() {
  ...
  handleKeyDown(o) {
    if (['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'].includes(o.key)) {
      const r = this.getAllRadios().filter(o => !o.disabled),
        i = ['ArrowUp', 'ArrowLeft'].includes(o.key) ? -1 : 1;
      let s = r.indexOf(this.host) + i;
      s < 0 && (s = r.length - 1),
        s > r.length - 1 && (s = 0),
        this.getAllRadios().map(o => (o.checked = !1)),
        r[s].setFocus(),
        (r[s].checked = !0),
        o.preventDefault();
    }
  ...
  render() {
    return i(
        ...
        i(
          ...
          i(
            ...
            i(
              ...
              i('g', { fill: 'currentColor' }, i('circle', { cx: '8', cy: '8', r: '3.42857143' }))
            )
          )
        ),
        i('input', {
      ...
      i('span', { part: 'label', id: this.labelId, class: 'radio__label' }, i('slot', null))
    );
  }
  get host() {
    return s(this);
